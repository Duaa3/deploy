...
import com.hotels.com.hotels.POJO.User;
import com.hotels.com.hotels.constents.HotelsConstants;
import com.hotels.com.hotels.dao.UserDao;
import com.hotels.com.hotels.service.UserService;
...
public class UserServiceImpl implements UserService {
        ...
        try {
            if (validaSignUpMap(requestMap)) {
                ...
                if (Objects.isNull(user)) {
                    ...
                    return hotelsUtils.getResponeEntity("Successfully  Registered.", HttpStatus.OK);
                } else {
                    //System.out.println("Email already exits.");
                    return hotelsUtils.getResponeEntity("Email already exits.", HttpStatus.BAD_REQUEST);
                }
            } else {
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if (!optional.isEmpty()) {
                    ...
                    return hotelsUtils.getResponeEntity("User Status is updated Successfully", HttpStatus.OK);

                } else {
                    return hotelsUtils.getResponeEntity("User id doesn't exist", HttpStatus.OK);
                }
            } else {
    ...
    public ResponseEntity<String> checkToken() {
        return hotelsUtils.getResponeEntity("true", HttpStatus.OK);
    }
        ...
        try {
            ...
            if (!user.equals(null)) {
                if (user.getPassword().equals(requestMap.get("oldPassword"))) {
                    ...
                    userDao.save(user);
                    return hotelsUtils.getResponeEntity("Password Updated Successfully", HttpStatus.OK);
                }
                return hotelsUtils.getResponeEntity("Incorrect Old Password", HttpStatus.BAD_REQUEST);
            }
            return hotelsUtils.getResponeEntity(HotelsConstants.SOMETHING_WENT_WRONG, HttpStatus.INTERNAL_SERVER_ERROR);
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public ResponseEntity<String> forgetPassword(Map<String, String> requestMap) {
        ...
        try {
            ...
            if (!Objects.isNull(user) && !Strings.isNullOrEmpty(user.getEmail())) {
                ...
                return hotelsUtils.getResponeEntity("Check Your mail for Credentials", HttpStatus.OK);
            }
