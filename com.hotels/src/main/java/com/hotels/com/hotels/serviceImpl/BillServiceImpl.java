...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if (validateResquestMap(requestMap)) {
                ...
                PdfWriter.getInstance(document, new FileOutputStream(HotelsConstants.STORE_LOCATION + "\\" + filename + ".pdf"));
                document.open();
                ...
                // Print table data
                JSONArray jsonArray = hotelsUtils.getJsonArrayFromString((String) requestMap.get("productDetails"));
                for (int i = 0; i < jsonArray.length(); i++) {
                    addRows(table, hotelsUtils.getMapFromJson(jsonArray.getString(i)));
                }
            ...
            return hotelsUtils.getResponeEntity("Required data not found", HttpStatus.BAD_REQUEST);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public ResponseEntity<byte[]> getPdf(Map<String, Object> requestMap) {
        ...
        try {
            ...
            String filepath = HotelsConstants.STORE_LOCATION + "\\" + (String) requestMap.get("uuid") + ".pdf";

            if (hotelsUtils.isFileExist(filepath)) {
        ...
        try {
            if (jwtFilter.isAdmin()) {
                ...
                if (!optional.isEmpty()) {
                    ...
                    return hotelsUtils.getResponeEntity("Bill is deleted successfully", HttpStatus.OK);
                }
                //System.out.println("Product id doesn't exist");
                return hotelsUtils.getResponeEntity("Bill id doesn't exist", HttpStatus.OK);
            } else {
    ...
    private void insertBill(Map<String, Object> requestMap) {
        try {
            ...
            bill.setRoomDetails((String) requestMap.get("roomDetails"));
    ...
    private void addTableHeader(PdfPTable table) {
        ...
        Stream.of("Name", "Hotel", "Quantity", "Price", "Sub Total")
                .forEach(columnTitle -> {
    ...
    private void addRows(PdfPTable table, Map<String, Object> data) {
        ...
        table.addCell((String) data.get("Hotel"));
